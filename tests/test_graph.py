...
class TestLoadMapping(unittest.TestCase):
    ...
    def test_all_exact(self):
        ...
        with self.node2._managed_cursor() as cur:
            ...
            expected = [
                (1,  1, 1, 1,  25.0, b'\xe0', 0.5),
                (2,  1, 1, 2,  25.0, b'\xe0', 0.5),
                (3,  1, 2, 3,  50.0, b'\xe0', 1.0),
                (4,  1, 3, 3,  50.0, b'\xe0', 1.0),
                (5,  1, 4, 4,  55.0, b'\xe0', 1.0),
                (6,  1, 5, 5,  50.0, b'\xe0', 1.0),
                (7,  1, 6, 6, 100.0, b'\xe0', 1.0),
                (8,  1, 7, 7, 100.0, b'\xe0', 1.0),
                (9,  1, 8, 8, 100.0, b'\xe0', 1.0),
                (10, 1, 9, 9, 100.0, b'\xe0', 1.0),
                (11, 1, 0, 0,   0.0, None,    1.0),
            ]
    ...
    def test_some_ambiguous(self):
        ...
        with self.node2._managed_cursor() as cur:
            results = cur.execute('SELECT * FROM relation').fetchall()
            expected = [
                (1,  1, 1, 1, 12.5,    b'\xc0', 0.25),
                (2,  1, 1, 2, 37.5,    b'\xc0', 0.75),
                (3,  1, 2, 3, 37.5,    b'\x80', 1.0),
                (4,  1, 3, 3, 62.5,    b'\x80', 1.0),
                (5,  1, 4, 4, 19.6875, b'\x80', 0.25),
                (6,  1, 4, 5, 59.0625, b'\x80', 0.75),
                (7,  1, 5, 4, 6.5625,  b'\x80', 0.25),
                (8,  1, 5, 5, 19.6875, b'\x80', 0.75),
                (9,  1, 6, 6, 28.125,  b'\x80', 0.375),
                (10, 1, 6, 8, 23.4375, b'\x80', 0.3125),
                (11, 1, 6, 9, 23.4375, b'\x80', 0.3125),
                (12, 1, 7, 7, 100.0,   b'\xe0', 1.0),
                (13, 1, 8, 6, 56.25,   b'\x80', 0.375),
                (14, 1, 8, 8, 46.875,  b'\x80', 0.3125),
                (15, 1, 8, 9, 46.875,  b'\x80', 0.3125),
                (16, 1, 9, 6, 28.125,  b'\x80', 0.375),
                (17, 1, 9, 8, 23.4375, b'\x80', 0.3125),
                (18, 1, 9, 9, 23.4375, b'\x80', 0.3125),
                (19, 1, 0, 0, 0.0,     None,    1.0),
            ]
            self.assertEqual(results, expected)
    ...
    def test_bidirectional_mapping(self):
        ...
        with self.node1._managed_cursor() as cur:
            results = cur.execute('SELECT * FROM relation').fetchall()
            expected = [
                (1, 1, 1, 1, 12.5, b'\xe0', 1.0),
                (2, 1, 2, 1, 37.5, b'\xe0', 1.0),
                (3, 1, 3, 2, 37.5, b'\x80', 0.375),
                (4, 1, 3, 3, 62.5, b'\x80', 0.625),
                (5, 1, 4, 4, 55.0, b'\xe0', 1.0),
                (6, 1, 5, 5, 50.0, b'\xe0', 1.0),
                (7, 1, 0, 0,  0.0, None,    1.0),
            ]
            self.assertEqual(results, expected)
