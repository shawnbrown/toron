...
class TestNodeDisaggregateGenerator(unittest.TestCase):
    ...
    def test_default_weight_group(self):
        ...
        expected = [
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   187075.0),
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 187075.0),
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   668125.0),
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 668125.0),
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   218.75),   # <- Disaggreated.
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   781.25),   # <- Disaggreated.
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 218.75),   # <- Disaggreated.
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 781.25),   # <- Disaggreated.
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   18432.0),  # <- Disaggreated.
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   55296.0),  # <- Disaggreated.
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 18432.0),  # <- Disaggreated.
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 55296.0),  # <- Disaggreated.
        ]
    ...
    def test_matching_group_and_default(self):
        ...
        expected = [
            ...
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   668125.0),
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 668125.0),
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   500.0),    # <- Disaggreated by group 2
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   500.0),    # <- Disaggreated by group 2
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 218.75),   # <- Disaggreated by default (group 1)
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 781.25),   # <- Disaggreated by default (group 1)
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   36864.0),  # <- Disaggreated by group 2
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   36864.0),  # <- Disaggreated by group 2
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 18432.0),  # <- Disaggreated by default (group 1)
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 55296.0),  # <- Disaggreated by default (group 1)
        ]
        self.assertEqual(list(results), expected)
    ...
    def test_matching_multiple_groups(self):
        ...
        expected = [
            ...
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   500.0),    # <- Disaggreated by group 2
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   500.0),    # <- Disaggreated by group 2
            (Index(id=1, labels=('OH', 'BUTLER')),   AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 250.0),    # <- Disaggreated by group 3
            (Index(id=2, labels=('OH', 'FRANKLIN')), AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 750.0),    # <- Disaggreated by group 3
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   36864.0),  # <- Disaggreated by group 2
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=1, attributes={'category': 'TOTAL', 'sex': 'MALE'}),   36864.0),  # <- Disaggreated by group 2
            (Index(id=3, labels=('IN', 'KNOX')),     AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 36864.0),  # <- Disaggreated by group 3
            (Index(id=4, labels=('IN', 'LAPORTE')),  AttributeGroup(id=2, attributes={'category': 'TOTAL', 'sex': 'FEMALE'}), 36864.0),  # <- Disaggreated by group 3
        ]
        self.assertEqual(list(results), expected)
